...
<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE `MasocolInfo` SET `firstname`='$first_name',`lastname`='$last_name',`age`='$age',`address`='$address',`contact`='$contact',`birthday`='$birthday' WHERE `ID`='$id'"; 
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `masocolinfo` WHERE `ID`='$id'";
