...
<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE `Registration` SET `firstname`='$first_name',`lastname`='$last_name',`age`='$age',`address`='$address',`contact`='$contact',`birthday`='$birthday' WHERE `ID`='$id'"; 
        ...
        if ($result == TRUE) {
            ...
            echo header("Location: demoDB.php");
        }else{
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `gumangcaminfo` WHERE `ID`='$id'";
